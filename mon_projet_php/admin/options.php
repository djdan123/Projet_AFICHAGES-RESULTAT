...
if (isset($_GET['supprimer'])) {
    ...
    $conn->query("DELETE FROM option WHERE idoption=$id");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST['nomOption'])) {
    ...
    $conn->query("INSERT INTO option (nomOption) VALUES ('$nom')");
    header("Location: options.php");
    exit;
}

$result = $conn->query("SELECT * FROM option ORDER BY idoption DESC");
?>
